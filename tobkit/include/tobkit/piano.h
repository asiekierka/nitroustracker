...
{
public:
	Piano(u16 _x, u16 _y, u16 _width, u16 _height, u16 *_char_base,
	      u16 *_screen_base, Screen *_screen);
	virtual ~Piano();
...
private:
	...
	unsigned short piano_Palette[16], piano_fullnotehighlight_Palette[16],
	    piano_halfnotehighlight_Palette[16];
#endif

	void draw(void);
	int getKeyXOffset(int key) const;
	bool isSharpNote(u8 note) const;
	void genPal(u16 *piano_cols_base, u16 *pal, u16 *pal_full_highlight,
