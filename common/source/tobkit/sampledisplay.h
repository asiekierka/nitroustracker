...
#define SNAP_TO_ZERO_CROSSING_RADIUS                                           \
	32 // Search 32 samples to the left and to the right to find a zero crossing
...
public:
	...
	SampleDisplay(u16 _x, u16 _y, u16 _width, u16 _height, Screen *_screen,
	              Sample *_smp = 0);
	~SampleDisplay(void);
