...
public:
	...
	PatternLocatedAction(State *state)
	    : PatternLocatedAction(state, state->channel, state->getCursorRow()) {};
...
{
public:
	MultipleCellSetAction(State *state, u8 channel, u16 row, CellArray *array,
	                      bool clone);
